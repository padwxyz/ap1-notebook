...
<section class="pl-24 pr-20 my-10 ml-56 flex-grow">
    ...
    <div>
        <div class="mb-4 mt-5">
            <label for="location" class="block text-gray-700 text-sm font-bold mb-2">Item:</label>
            <select id="location" name="location" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                ...
                <option value="location1">Item 1</option>
                <option value="location2">Item 2</option>
                <option value="location3">Item 3</option>
            </select>
        </div>
        <a href="">
