...
<section class="pl-24 pr-20 my-10 ml-56 flex-grow">
    <div class="justify-between items-center">
        <h1 class="text-[42px] font-bold">View Activity by Location</h1>
    ...
    <div>
        <form action="{{ route('activity.filter') }}" method="GET">
            ...
            <div class="mb-4 mt-5">
                ...
                <select id="location" name="filter_value" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
