...
<section class="pl-24 pr-20 my-10 ml-56 flex-grow">
    <div class="justify-between items-center">
        <h1 class="text-[42px] font-bold">View Activity by Facility</h1>
        @include('components.partials.activitybar')
    </div>

    <div>
        <form action="{{ route('activity.filter') }}" method="GET">
            <input type="hidden" name="filter_type" value="facility">
            <div class="mb-4 mt-5">
                <label for="facility" class="block text-gray-700 text-sm font-bold mb-2">Facility:</label>
                <select id="facility" name="filter_value" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
