    ...
    <div>
        <form action="{{ route('activity.filter') }}" method="GET">
            ...
            <div class="mb-4 mt-5">
                ...
                <select id="item" name="filter_value" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
