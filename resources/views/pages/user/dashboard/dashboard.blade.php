                    ...
                    @foreach($recentActivities as $activity)
                        <li class="mb-4">
                            <div class="flex justify-between">
                                <div>
                                    <h3 class="text-xl font-bold">{{ $activity->problem }}</h3>
                                    <p>{{ $activity->activity }}</p>
                                    <p class="text-gray-500">Date: {{ \Carbon\Carbon::parse($activity->date)->format('d/m/Y') }}</p>
                                </div>
                                <div class="px-4 py-2 rounded-lg text-white
                                    ...
                                    @elseif($activity->status == 'cancel') bg-red-500
                                    @endif">
