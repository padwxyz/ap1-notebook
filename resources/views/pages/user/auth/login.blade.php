                ...
                <div class="flex items-center justify-center w-full lg:p-12">
                    <div class="flex items-center xl:p-10">
                        ...
                        <form action="{{ route('login') }}" method="POST"
                            ...
                            @csrf
                            <h3 class="mb-3 text-3xl sm:text-4xl font-extrabold text-[#0045A4]">Login</h3>
                            ...
                            <div class="flex flex-row justify-between mb-5 mt-5">
                                <label class="relative inline-flex items-center cursor-pointer select-none">
                                    ...
                                    <span class="ml-3 text-sm sm:text-base font-normal text-grey-900">Keep me logged in</span>
                                </label>
                                <a href="javascript:void(0)" class="text-sm sm:text-base font-medium text-[#0045A4]">Forget password?</a>
                            </div>
