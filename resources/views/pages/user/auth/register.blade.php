...
@section('container')
    <section>
        <div class="container flex flex-col mx-auto bg-white rounded-lg px-4 md:px-8">
            {{-- Flash Message --}}
            @if(session('success'))
                <div class="relative bg-green-100 border-t-4 border-green-500 text-teal-900 px-4 py-3 shadow-md w-full sm:w-[400px] md:w-[500px] mx-auto rounded-2xl mb-6 mt-5" role="alert">
                    <div class="flex justify-between items-center">
                        ...
                        <button type="button" class="absolute top-0 right-0 mt-2 mr-2 text-teal-500 hover:text-teal-700 focus:outline-none" onclick="this.parentElement.parentElement.style.display='none';">
            ...
            @if(session('failed'))
                <div class="relative bg-red-100 border-t-4 border-red-500 text-white-900 px-4 py-3 shadow-md w-full sm:w-[400px] md:w-[500px] mx-auto rounded-2xl mb-6 mt-5" role="alert">
                    <div class="flex justify-between items-center">
                        <div class="flex">
                            <div class="py-1">
                ...
                <div class="flex items-center justify-center w-full lg:p-12">
                    <div class="flex items-center xl:p-10">
                        ...
                        <form action="{{ route('register') }}" method="POST"
                            ...
                            @csrf
                            <h3 class="mb-3 text-3xl sm:text-4xl font-extrabold text-[#0045A4]">Register</h3>
                            ...
                            {{-- Username Input --}}
                            <label for="username" class="mb-2 text-sm sm:text-base text-start text-grey-900">Username</label>
                            <input id="username" name="username" type="text" value="{{ old('username') }}"
                                placeholder="Input your username"
                                class="flex items-center px-5 py-4 mb-3 text-sm sm:text-base font-medium outline-none focus:bg-white placeholder:text-grey-700 bg-slate-100 text-dark-grey-900 rounded-2xl border @error('username') border-red-500 @else border-slate-300 @enderror">
                            @error('username')
                                <span class="text-sm text-red-500 text-left block">{{ $message }}</span>
                            @enderror

                            {{-- Password Input --}}
                            <label for="password" class="mb-2 text-sm sm:text-base text-start text-grey-900">Password</label>
                            ...
                            <label for="password_confirmation" class="mb-2 text-sm sm:text-base text-start text-grey-900">Confirm Password</label>
                            ...
                            <div class="flex flex-row justify-between mb-5 mt-5">
                                <label class="relative inline-flex items-center cursor-pointer select-none">
                                    ...
                                    <span class="ml-3 text-sm sm:text-base font-normal text-grey-900">I agree to the terms and conditions</span>
                                </label>
                            </div>

                            <button type="submit"
                                class="px-6 py-5 mb-5 text-sm sm:text-base font-bold leading-none text-white transition duration-300 rounded-2xl hover:bg-[#003080] focus:ring-4 focus:ring-[#0045A4]/50 bg-[#0045A4]">
                                Register
                            </button>
        ...
        <div class="flex flex-wrap -mx-3 my-5">
            <div class="w-full max-w-full sm:w-3/4 mx-auto text-center">
                <a href="{{ route('landing_page') }}">
                    ...
                    <p class="text-sm sm:text-base text-slate-500 py-1">Angkasa Pura I Notebook</p>
                </a>
            </div>
        </div>
    </section>
